...
export const fakeData: PortfolioData = {
  ...
  artworks: [
    { id: 'still-life', title: 'Still Life in Shadow', year: 2023, createdAt: '2023-04-12', mediumId: 'digital-painting', paintingCategoryIds: ['digital-painting', 'table-series'], description: 'A study of light, everyday objects and negative space.', dimensions: '3000 × 4000 px', image: { src: '/artworks/artwork-13.png', alt: 'Black and white still life with a hanging lamp and folded fabric', width: 840, height: 1121, flipX: true },  hoverImage: { src: '/artworks/artwork-7.png', alt: 'A monochrome study of a plate and objects on a table', width: 841, height: 1122 }, table: { rotation: -10, aspectRatio: 0.75 } },
    { id: 'table-study', title: 'Table Study', year: 2022, createdAt: '2022-09-08', mediumId: 'digital-painting', paintingCategoryIds: ['digital-painting', 'table-series'], description: 'An observational composition in black and white.', dimensions: '3000 × 4000 px', image: { src: '/artworks/artwork-7.png', alt: 'A monochrome study of a plate and objects on a table', width: 841, height: 1122 },  hoverImage: { src: '/artworks/artwork-6.png', alt: 'Black and white painting of a plate, fork and knife', width: 838, height: 1120 }, table: { rotation: -12.96, aspectRatio: 0.75 } },
    { id: 'in-transit', title: 'In Transit', year: 2024, createdAt: '2024-02-16', mediumId: 'charcoal', paintingCategoryIds: ['charcoal'], description: 'An exploratory line study based on original photography.', dimensions: '3000 × 4000 px', image: { src: '/artworks/artwork-16.png', alt: 'An intricate line drawing of a quiet moment inside a vehicle', width: 840, height: 1121, flipX: true },  hoverImage: { src: '/artworks/artwork-12.png', alt: 'A line drawing of a cat riding in a car', width: 840, height: 1121 }, table: { rotation: 10, aspectRatio: 0.75 } },
    { id: 'floating', title: 'Floating', year: 2025, createdAt: '2025-07-03', mediumId: 'digital-painting', paintingCategoryIds: ['digital-painting'], description: 'A figure suspended in water, light and colour.', dimensions: '4000 × 3000 px', image: { src: '/images/5.jpg', alt: 'A painted figure floating in turquoise water', width: 4000, height: 3000, rotate: -90 },  hoverImage: { src: '/images/6.jpg', alt: 'Photograph of three white shells arranged in a circle on sand', width: 3024, height: 4032 }, table: { rotation: 10, aspectRatio: 1.334 } },
    { id: 'at-the-table', title: 'At the Table', year: 2023, createdAt: '2023-11-20', mediumId: 'digital-painting', paintingCategoryIds: ['digital-painting', 'table-series'], description: 'A shadow-pass study of a plate and cutlery.', dimensions: '3000 × 4000 px', image: { src: '/artworks/artwork-6.png', alt: 'Black and white painting of a plate, fork and knife', width: 838, height: 1120 },  hoverImage: { src: '/artworks/artwork-13.png', alt: 'Black and white still life with a hanging lamp and folded fabric', width: 840, height: 1121 }, table: { rotation: 0, aspectRatio: 0.748 } },
    { id: 'roxy-line-study', title: 'Roxy — Line Study', year: 2024, createdAt: '2024-05-09', mediumId: 'charcoal', paintingCategoryIds: ['charcoal', 'roxy-series'], description: 'The original line study for Roxy On A Ride.', dimensions: '3000 × 4000 px', image: { src: '/artworks/artwork-12.png', alt: 'A line drawing of a cat riding in a car', width: 840, height: 1121 },  hoverImage: { src: '/artworks/artwork-19.png', alt: 'Roxy the cat beside a steering wheel, rendered in bold black and white', width: 846, height: 1120 }, table: { rotation: 14.96, aspectRatio: 0.75 } },
    { id: 'roxy-on-a-ride', title: 'Roxy On A Ride', year: 2024, createdAt: '2024-06-18', mediumId: 'digital-painting', paintingCategoryIds: ['digital-painting', 'roxy-series'], description: 'Digital Painting based on Original Photography, shadow pass', dimensions: '3000*4000px', image: { src: '/artworks/artwork-19.png', alt: 'Roxy the cat beside a steering wheel, rendered in bold black and white', width: 846, height: 1120, flipX: true },  hoverImage: { src: '/artworks/artwork-16.png', alt: 'An intricate line drawing of a quiet moment inside a vehicle', width: 840, height: 1121 }, table: { rotation: 0, aspectRatio: 0.7554 } },
  ],
  projects: [{
    id: 'daily-notes',
    name: 'Daily Notes',
  ...
  },
    {
      id: 'quiet-rooms',
      name: 'Quiet Rooms',
      tagline: 'Small studies of interiors, pauses and the light that changes a room.',
      description: 'Quiet Rooms follows the same observational practice into domestic spaces. The project moves between ink studies, digital paintings and reference photographs, keeping each image deliberately close to the moment it records.',
      year: 2024,
      discipline: 'Illustration & Painting',
      client: 'Personal practice',
      myRole: ['Drawing', 'Digital painting'],
      images: [
        { src: '/images/4.jpg', alt: 'Line drawing of a figure sitting with a laptop in a bright room', width: 919, height: 1225, aspectRatio: 0.7502, caption: 'Afternoon — ink on paper' },
        { src: '/images/7.jpg', alt: 'High contrast black and white painting of folded fabric and shadow', width: 919, height: 1225, aspectRatio: 0.7502, caption: 'Folds — digital painting' },
        { src: '/images/1.png', alt: 'Black and white painting of a plate with a fork, a knife and a dark shape', width: 143, height: 190, aspectRatio: 0.7526, caption: 'Still life — charcoal on paper' },
        { src: '/images/2.jpg', alt: 'Ink line drawing of a birthday card, a candle and a plate on a table', width: 3024, height: 4032, aspectRatio: 0.75, caption: 'Table — ink on paper' },
      ],
      links: [{ id: 'series', label: 'View series', href: 'https://example.com/quiet-rooms' }],
      dynamicFields: { Medium: 'Ink, digital painting', Started: 'Spring 2024', Studies: '18 finished', Status: 'Completed' },
    },
    {
      id: 'water-notes',
      name: 'Water Notes',
      tagline: 'Reference photographs and painted studies built around movement, water and light.',
      description: 'Water Notes brings photography and painting together around fleeting poses and changing reflections. The project uses the same direct, one-sitting approach while allowing the final pieces to move further from the original reference.',
      year: 2025,
      discipline: 'Photography & Digital Painting',
      client: 'Personal practice',
      myRole: ['Photography', 'Digital painting'],
      images: [
        { src: '/images/5.jpg', alt: 'Photograph of a swimmer floating in turquoise water seen from above', width: 3024, height: 4032, aspectRatio: 0.75, caption: 'Water — reference photograph' },
        { src: '/images/6.jpg', alt: 'Photograph of three white shells arranged in a circle on sand', width: 3024, height: 4032, aspectRatio: 0.75, caption: 'Shells — reference photograph' },
        { src: '/images/3.jpg', alt: 'Line drawing of a ride seen through a car window with a figure outside', width: 3024, height: 4032, aspectRatio: 0.75, caption: 'Motion — ink on paper' },
        { src: '/images/7.jpg', alt: 'High contrast black and white painting of folded fabric and shadow', width: 919, height: 1225, aspectRatio: 0.7502, caption: 'Reflection — digital painting' },
      ],
      links: [{ id: 'notes', label: 'Process notes', href: 'https://example.com/water-notes' }],
      dynamicFields: { Medium: 'Photography, digital painting', Started: 'Summer 2025', Studies: '12 finished', Status: 'In progress' },
    },
  ],
};
