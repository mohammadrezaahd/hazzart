  ...
  return (
    <footer className="site-footer">
      <div
        ...
        style={{ "--item-count": footerItems.length } as React.CSSProperties}
        aria-label="Arrange artwork"
      >
        <span
        ...
        {footerItems.map((item, index) => (
          <button
            key={item.id}
            type="button"
            ref={item.id === "medium" ? mediumButton : undefined}
